    ...
    Stack! {
        ...
        children = ui_vec![
            ...
            Text! {
                ...
                background_color = rgba_pair(rgb(30, 30, 30), rgb(225, 225, 225));

                focusable = true;
                when *#is_focused {
                    txt = "focused";
                    background_color = rgba_pair(web_colors::DARK_GREEN, web_colors::LIGHT_GREEN);
                }
            },
        ]
    }
    ...
    Stack! {
        ...
        children = cmds.into_iter().map(|cmd| {
            Text! {
                ...
                when *#{cmd.is_enabled()} {
                    font_color = rgba_pair(colors::WHITE, colors::BLACK);
                }
            }.boxed()
        }).collect::<Vec<_>>();
    }
