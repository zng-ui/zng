...
fn font_size_example(font_size: ArcVar<Length>) -> impl UiNode {
    ...
    Stack! {
        ...
        spacing = 5;
        corner_radius = 4;
        background_color = rgba_pair(rgba(0, 0, 0, 40.pct()), rgba(1., 1., 1., 40.pct()));
        padding = 4;
        children = ui_vec![
            Button! {
                child = Text!("-");
...
fn basic() -> impl UiNode {
    section(
        ...
        ui_vec![
            ...
            Text! {
                font_color = rgba_pair(web_colors::LIGHT_GREEN, web_colors::DARK_GREEN);
                txt = "Colored Text";

                when *#is_hovered {
                    font_color = rgba_pair(web_colors::YELLOW, web_colors::BROWN);
                }
            },
            Text!("Emoticons 🔎👨‍💻🧐"),
        ],
