...
pub enum ClickArgsSource {
    /// Click event was generated by the [`MouseClick`](MouseClick) event.
    Mouse {
    ...
    /// Click event was generated by the [`KeyDown`](KeyDown) event with the [`VirtualKeyCode::Return`](VirtualKeyCode::Return) key.
    Key {
...
/// [`Click`](Click) when the [`click_count`](ClickArgs::click_count) is `1`.
pub struct SingleClick;
impl Event for SingleClick {
    type Args = ClickArgs;
}

/// [`Click`](Click) when the [`click_count`](ClickArgs::click_count) is `2`.
pub struct DoubleClick;
impl Event for DoubleClick {
    type Args = ClickArgs;
}

/// [`Click`](Click) when the [`click_count`](ClickArgs::click_count) is `3`.
