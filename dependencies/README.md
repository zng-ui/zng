...
The current *version* is the latest commit that was included in the Firefox 103.0 release, currently we are manually
...
2 - Checkout this commit in the `./webrender` sub-module.
    `git fetch` and `git checkout 36db6c769d6c653266889418c92c2b9853cc917a`

The current commit is this one: [`https://github.com/servo/webrender/commit/36db6c769d6c653266889418c92c2b9853cc917a`]