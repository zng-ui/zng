...
The current *version* is the latest commit that was included in the Firefox 98.0 release, currently we are manually
...
2 - Checkout this commit in the `./webrender` sub-module.
    `git fetch` and `git checkout 5baeb6e3e69cd1691ea1c6060e77b9b0b54d9ffe`

The current commit is this one: [`https://github.com/servo/webrender/commit/5baeb6e3e69cd1691ea1c6060e77b9b0b54d9ffe`]