...
The current *version* is the latest commit that was included in the Firefox 110.0 release, currently we are manually
...
2 - Checkout this commit in the `./webrender` sub-module.
    `git fetch` and `git checkout d451d220ef4fb56c9fb869057fb0ceed8946bde0`

The current commit is this one: [`https://github.com/servo/webrender/commit/d451d220ef4fb56c9fb869057fb0ceed8946bde0`]