...
use crate::{
    ...
    mouse::*,
    text::{ToText, Txt},
    touch::{TouchTapArgs, TOUCH_TAP_EVENT},
    units::DipPoint,
...
pub enum ClickArgsSource {
    ...
    /// Click event was generated by the [touch tap event](TOUCH_TAP_EVENT).
    Touch {
