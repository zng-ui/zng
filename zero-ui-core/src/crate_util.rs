    ...
    ($(#[$attrs:meta])* $vis:vis struct $Type:ident;) => {
        ...
        impl $Type {
            ...
            paste::paste! {
                ...
                pub const fn new_static() -> [<Static $Type>] {
                    [<Static $Type>]::new_unique()
                }
            }
        ...
        paste::paste! {
            ...
            #[allow(dead_code)]
            $vis struct [<Static $Type>](std::sync::atomic::AtomicU32);
            ...
            impl [<Static $Type>] {
                ...
                pub fn get(&self) -> $Type {
                    ...
                    if let Some(id) = std::num::NonZeroU32::new(id) {
                        $Type(id)
                    } else {
                        let id = $Type::new_unique().get();
...
macro_rules! unique_id_64 {
    ($(#[$attrs:meta])* $vis:vis struct $Type:ident;) => {
        ...
        paste::paste! {
            #[doc = "Lazy inited [`" $Type "`]."]  
            #[allow(dead_code)]
            $vis struct [<Static $Type>](std::sync::atomic::AtomicU64);
            ...
            $crate::impl_from_and_into_var! {
                /// Calls [`StaticWidgetId::get`].
                #[doc = "Calls [`Static" $Type "`::get]."]
                fn from(st: &'static [<Static $Type>]) -> $Type {
                    st.get()
                }
            }
        }
