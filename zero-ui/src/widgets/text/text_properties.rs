...
#[property(CONTEXT, default(FONT_FAMILY_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(FONT_STYLE_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(FONT_WEIGHT_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(FONT_STRETCH_VAR), widget_impl(Text))]
...
/// [`font_weight`]: fn@font_weight
/// [`font_style`]: fn@font_style
#[property(CONTEXT, default(FONT_SYNTHESIS_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(FONT_AA_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(FONT_SIZE_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(TEXT_COLOR_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(TEXT_TRANSFORM_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(LINE_HEIGHT_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(LETTER_SPACING_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(LINE_SPACING_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(WORD_SPACING_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(PARAGRAPH_SPACING_VAR), widget_impl(Text))]
...
///
/// [`hyphens`]: fn@hyphens
#[property(CONTEXT, default(WORD_BREAK_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(LINE_BREAK_VAR), widget_impl(Text))]
...
///
/// [`Text!`]: struct@crate::widgets::Text
#[property(CONTEXT, default(TEXT_ALIGN_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(JUSTIFY_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(TAB_LENGTH_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(WHITE_SPACE_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(FONT_VARIATIONS_VAR), widget_impl(Text))]
...
/// **Note:** This property fully replaces the font variations for the widget and descendants, use [`with_font_variation`]
/// to create a property that sets a variation but retains others from the context.
#[property(CONTEXT, default(FONT_FEATURES_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(FontFeatureState::auto()), widget_impl(Text))]
...
#[property(CONTEXT, default(CapsVariant::Auto), widget_impl(Text))]
...
#[property(CONTEXT, default(NumVariant::Auto), widget_impl(Text))]
...
#[property(CONTEXT, default(NumSpacing::Auto), widget_impl(Text))]
...
#[property(CONTEXT, default(NumFraction::Auto), widget_impl(Text))]
...
#[property(CONTEXT, default(FontStyleSet::auto()), widget_impl(Text))]
...
#[property(CONTEXT, default(CharVariant::auto()), widget_impl(Text))]
...
#[property(CONTEXT, default(FontPosition::Auto), widget_impl(Text))]
...
#[property(CONTEXT, default(JpVariant::Auto), widget_impl(Text))]
...
#[property(CONTEXT, default(CnVariant::Auto), widget_impl(Text))]
...
#[property(CONTEXT, default(EastAsianWidth::Auto), widget_impl(Text))]
...
#[property(CONTEXT, default(LANG_VAR), widget_impl(Text))]
...
///
/// [`lang`]: fn@lang
#[property(CONTEXT+1, default(DIRECTION_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(UNDERLINE_THICKNESS_VAR, UNDERLINE_STYLE_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(UNDERLINE_COLOR_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(UNDERLINE_SKIP_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(UNDERLINE_POSITION_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(OVERLINE_THICKNESS_VAR, OVERLINE_STYLE_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(OVERLINE_COLOR_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(STRIKETHROUGH_THICKNESS_VAR, STRIKETHROUGH_STYLE_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(STRIKETHROUGH_COLOR_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(CARET_COLOR_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(TEXT_EDITABLE_VAR), widget_impl(Text))]
...
/// [`hyphens`]: fn@hyphens
#[property(CONTEXT, default(TEXT_WRAP_VAR), widget_impl(Text))]
...
#[property(CONTEXT, default(HYPHENS_VAR), widget_impl(Text))]
...
///
/// [`hyphens`]: fn@hyphens
#[property(CONTEXT, default(HYPHEN_CHAR_VAR), widget_impl(Text))]
