...
#[property(CONTEXT)]
pub fn access_role(child: impl IntoUiNode, role: impl IntoVar<AccessRole>) -> UiNode {
    with_access_state(child, role, |b, v| b.set_role(*v))
}

/// Append supported access commands.
#[property(CONTEXT)]
pub fn access_commands(child: impl IntoUiNode, commands: impl IntoVar<Vec<AccessCmdName>>) -> UiNode {
...
pub fn accessible(child: impl IntoUiNode, accessible: impl IntoVar<bool>) -> UiNode {
...
#[property(CONTEXT)]
pub fn current(child: impl IntoUiNode, kind: impl IntoVar<CurrentKind>) -> UiNode {
...
/// [`invalid`]: fn@invalid
#[property(CONTEXT)]
pub fn error_message(child: impl IntoUiNode, invalid_wgt: impl IntoVar<WidgetId>) -> UiNode {
...
#[property(CONTEXT)]
pub fn active_descendant(child: impl IntoUiNode, descendant: impl IntoVar<WidgetId>) -> UiNode {
...
/// [`owns`]: fn@owns
#[property(CONTEXT)]
pub fn expanded(child: impl IntoUiNode, expanded: impl IntoVar<bool>) -> UiNode {
    with_access_state(child, expanded, |b, v| b.set_expanded(*v))
}

/// Indicates the availability and type of interactive popup widget.
#[property(CONTEXT)]
pub fn popup(child: impl IntoUiNode, popup: impl IntoVar<Popup>) -> UiNode {
...
#[property(CONTEXT)]
pub fn label(child: impl IntoUiNode, label: impl IntoVar<Txt>) -> UiNode {
...
/// [`labelled_by`]: fn@labelled_by
#[property(CONTEXT)]
pub fn labelled_by_child(child: impl IntoUiNode, enabled: impl IntoVar<bool>) -> UiNode {
...
#[property(CONTEXT)]
pub fn level(child: impl IntoUiNode, hierarchical_level: impl IntoVar<NonZeroU32>) -> UiNode {
    with_access_state(child, hierarchical_level, |b, v| b.set_level(*v))
}

/// Indicates that the user may select more than one item from the current selectable descendants.
#[property(CONTEXT)]
pub fn multi_selectable(child: impl IntoUiNode, multi_selectable: impl IntoVar<bool>) -> UiNode {
...
#[property(CONTEXT)]
pub fn orientation(child: impl IntoUiNode, orientation: impl IntoVar<Orientation>) -> UiNode {
...
#[property(CONTEXT)]
pub fn placeholder(child: impl IntoUiNode, placeholder: impl IntoVar<Txt>) -> UiNode {
...
#[property(CONTEXT)]
pub fn read_only(child: impl IntoUiNode, read_only: impl IntoVar<bool>) -> UiNode {
...
#[property(CONTEXT)]
pub fn selected(child: impl IntoUiNode, selected: impl IntoVar<bool>) -> UiNode {
...
#[property(CONTEXT)]
pub fn sort(child: impl IntoUiNode, direction: impl IntoVar<SortDirection>) -> UiNode {
    with_access_state(child, direction, |b, v| b.set_sort(*v))
}

/// Set the maximum value (inclusive).
#[property(CONTEXT)]
pub fn value_max(child: impl IntoUiNode, max: impl IntoVar<f64>) -> UiNode {
    with_access_state(child, max, |b, v| b.set_value_max(*v))
}

/// Set the minimum value (inclusive).
#[property(CONTEXT)]
pub fn value_min(child: impl IntoUiNode, min: impl IntoVar<f64>) -> UiNode {
    with_access_state(child, min, |b, v| b.set_value_min(*v))
}

/// Set the current value.
#[property(CONTEXT)]
pub fn value(child: impl IntoUiNode, value: impl IntoVar<f64>) -> UiNode {
    with_access_state(child, value, |b, v| b.set_value(*v))
}

/// Set a text that is a readable version of the current value.
#[property(CONTEXT)]
pub fn value_text(child: impl IntoUiNode, value: impl IntoVar<Txt>) -> UiNode {
...
#[property(CONTEXT)]
pub fn col_index(child: impl IntoUiNode, index: impl IntoVar<usize>) -> UiNode {
...
#[property(CONTEXT)]
pub fn row_index(child: impl IntoUiNode, index: impl IntoVar<usize>) -> UiNode {
...
#[property(CONTEXT)]
pub fn item_count(child: impl IntoUiNode, count: impl IntoVar<usize>) -> UiNode {
...
#[property(CONTEXT)]
pub fn item_index(child: impl IntoUiNode, index: impl IntoVar<usize>) -> UiNode {
...
#[property(CONTEXT)]
pub fn invalid(child: impl IntoUiNode, error: impl IntoVar<Invalid>) -> UiNode {
...
#[property(CONTEXT)]
pub fn lang(child: impl IntoUiNode, lang: impl IntoVar<Lang>) -> UiNode {
...
#[property(CONTEXT)]
pub fn scroll_horizontal(child: impl IntoUiNode, normal_x: impl IntoVar<Factor>) -> UiNode {
...
#[property(CONTEXT)]
pub fn scroll_vertical(child: impl IntoUiNode, normal_y: impl IntoVar<Factor>) -> UiNode {
