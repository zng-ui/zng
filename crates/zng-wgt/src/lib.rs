...
mod __prelude {
    ...
    pub use zng_var::{
        ...
        VarValue, WeakVar, context_var, impl_from_and_into_var, response_done_var, response_var, var, var_default, var_expr, var_from,
        var_local, var_merge, var_state, var_when,
    };
