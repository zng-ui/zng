...
//! [`Handler<A>`]. Commands are specialized events represented by a static instance of [`Command`]
...
mod __prelude_wgt {
    ...
    pub use zng_var::{
        ...
        context_var, expr_var, impl_from_and_into_var, impl_property_value, merge_var, response_done_var, response_var, var, var_getter,
        var_state, when_var,
    }; // TODO(breaking): add flat_expr_var!
