...
//! ```toml
//! [dependencies]
//! zng = { version = "0.15.11", features = ["view_prebuilt"] }
//! ```
//!
...
mod __prelude {
    ...
    pub use zng_var::{
        IntoValue, IntoVar, Var, VarValue, context_var, var, expr_var, var_from, var_getter, const_var, merge_var, var_state, when_var,
    };
...
mod __prelude_wgt {
    ...
    pub use zng_var::{
        ...
        impl_from_and_into_var, response_done_var, response_var, var, expr_var, var_getter, const_var, merge_var, var_state, when_var,
    };
