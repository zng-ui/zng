...
//! ```toml
//! [dependencies]
//! zng = { version = "0.20.5", features = ["view_prebuilt"] }
//! ```
//!
//! ```no_run
//! use zng::prelude::*;
...
pub use zng_app::{
    AppBuilder, AppControlFlow, AppEventObserver, AppExtension, AppExtensionBoxed, AppExtensionInfo, AppStartArgs, DInstant, Deadline,
