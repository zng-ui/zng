...
pub const ZNG_ENV_VIEW_PROCESS: &str = "zng-view-prebuilt/view-process";

zng_env::process_main!("zng-view-prebuilt/view-process" => view_process_main);

fn view_process_main() -> ! {
